...
const Metamask_comp_text = () => {
	...
	if (status === 'initializing')
		return (
			<a
				className="js-wallet bg-accent  hover:bg-accent-dark block w-full btn_border_2 r py-3 px-8 text-center font-semibold text-white transition-all"
				href="/login"
			>
				Connect Wallet
			</a>
	...
	if (status === 'unavailable')
		return (
			<a
				className="js-wallet bg-accent  hover:bg-accent-dark block w-full btn_border_2  py-3 px-8 text-center font-semibold text-white transition-all"
				href="/login"
			>
				Connect Wallet
			</a>
	...
	if (status === 'connecting')
		return (
			<div className="js-wallet bg-accent btn_border_2 hover:bg-accent-dark block w-full  py-3 px-8 text-center font-semibold text-white transition-all">
				Connecting...
			</div>
		);
